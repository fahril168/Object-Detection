...
print("Tekan 'b' untuk mengambil background (median)...")
...
while True:
    ...
    if key == ord('b'):
        print("Mengambil 30 frame untuk median background...")
        frames = []
        for _ in range(30):
            ret2, f = cap.read()
            if not ret2:
